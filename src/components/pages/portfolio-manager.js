...
export default class PortfolioManager extends Component {
    ...
    getPortfolioItems() {
        axios.get("https://patrickneary.devcamp.space/portfolio/portfolio_items?order_by=created_at&direction=desc", 
        { withCredentials: true })
        .then(response => {
            this.setState({
            ...
            console.log("You done messed up in getPortfolioItems A A Ron!", error)
        })
    }
